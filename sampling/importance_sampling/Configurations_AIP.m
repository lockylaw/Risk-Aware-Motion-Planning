...
for i = 45
    ...
    % collision probability and variance of the whole stage path
    [ColliProb(i), ColliVar(i), time(i)] = ...
        AISCollisionProbability_Tra(model, planning_result_sin, OptionsAIS, ax_main_origin);
    
%     % collision probability and variance of seperated way points in stage
%     % path
%     [ColliProb_AIS_Group, ColliVar_AIS_Group, time_Group] = ...
%         AISCollisionProbability_Tra(model, planning_result_sin, OptionsAIS, ax_main_origin);
